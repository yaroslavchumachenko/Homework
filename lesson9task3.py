...
# (similar to `wc` Unix-utility, for additional info about it follow the link: https://www.geeksforgeeks.org/wc-command-linux-examples/
...
# Such a filename generally might be passed-in, hard-coded, input with input(), or pulled from a command-line via the sys.argv list; 
...
# if you’re feeling ambitious, you may be able to improve this by passing an open file object into the two count functions (hint: file.seek(0) is a file rewind).